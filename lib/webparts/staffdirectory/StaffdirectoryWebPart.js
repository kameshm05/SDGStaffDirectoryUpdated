            ...
            case 10:
                ...
                return [4 /*yield*/, sp.web
                        ...
                        listitem.forEach(function (li) {
                            ...
                            var userpic = ProfilePics.filter(function (p) { return p.ListItemAllFields.UserName && li.User.EMail ? p.ListItemAllFields.UserName.toLowerCase() == li.User.EMail.toLowerCase() : ""; });
...
function getTableData() {
    return __awaiter(this, void 0, void 0, function () {
        var OfficeTable, EmpTable, OutTable, AffTable, AlumTable, AllDetailsTable, BillingRateTable, OfficeDetails, AvailHtml, options;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    OfficeTable = "";
                ...
                case 1:
                    ...
                    UserDetails.forEach(function (details) {
                        ...
                        AllDetailsTable += "<tr><td class=\"user-details-td\"><div  class=\"usernametag\"><img src=\"" + details.ProfilePic + "\" width=\"30\" height=\"30\" />" + details.Name + "</div><div class=\"HUserDetails\">\n    <img src=\"" + details.ProfilePic + "\" class=\"userimg\"/>\n    <div class=\"user-name\">" + details.Name + "</div>\n    <div class=\"user-JTitle\">" + details.Title + "</div>\n    <div class=\"user-location\">" + details.Location + "</div>\n    <div class=\"user-avail-title\">Availability</div>\n    <div class=\"user-JTitle\">" + details.Availability + "%</div>\n    </div></td><td>" + details.FirstName + "</td><td>" + details.LastName + "</td><td>" + ViewPhoneNumber.join(",") + "</td><td>" + (details.Location == "" || details.Location == null
                            ...
                            ? "Not Available"
                            : "" + details.Assistant) + "</td></tr>";
                        BillingRateTable += "<tr><td class=\"usernametag\"><img src=\"" + details.ProfilePic + "\" width=\"30\" height=\"30\" />" + details.Name + "</td><td>" + details.Title + "</td><td><div>" + (details.USDDaily == "" || details.USDDaily == null
                            ? ""
...
var UserProfileDetail = function () { return __awaiter(_this, void 0, void 0, function () {
    var viewDir, editDir, editbtn, submitbtn, cancelbtn, office, userpage, username, sdhEmp, Edit, UserView, UserEdit, StaffStatus, WorkscheduleSection, viewBiling;
    var _this = this;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                ...
                username.forEach(function (btn) {
                    btn.addEventListener("click", function (e) { return __awaiter(_this, void 0, void 0, function () {
                        var filesHtml, editfileHtml, files, billingRateHtml, html, phno, val, i, temp, editfMonth, editfday, Sdd, Smm, Syyyy, Sdateformat;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
...
var editFunction = function () { return __awaiter(_this, void 0, void 0, function () {
    var Edit, UserView, UserEdit, adminviewBilling, userviewBilling, viewBiling, billingRateHtml, MobileNumberHtmlSec, HomeNumberHtmlSec, EmergencyNumberHtmlSec, MCCodeArr, AllMnumber, AllMobileNumbers, HCCodeArr, AllHNumber, AllHomeNumber, ECCodeArr, AllENumber, AllEmergencyNumber, emailAddress, divID;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
var editsubmitFunction = function () { return __awaiter(_this, void 0, void 0, function () {
    var mobNumUpdate, homeNumUpdate, emergencyNumUpdate, mobNumbers, homeNumbers, emergencyNumbers, dispTitle, pickerDiv, peoplePicker, userInfo, profileID, loginName, profile, insertObj, update, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                mobNumUpdate = "";
...
var useravailabilityDetails = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        // .getAll();
        availList = AllAvailabilityDetails.filter(function (a) { return a.UserName.EMail == SelectedUserProfile[0].Usermail; });
